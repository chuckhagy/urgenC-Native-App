          ...
          <View style={style.aRow}>
            <View>
              <Text style={style.innerText}>
                Passed Goals:{" "}
                {allItems.filter(item => item.completed && item.success).length}
              </Text>
              <Text style={style.innerText}>
                Failed Goals:{" "}
                {allItems.filter(item => item.completed && item.failure).length}
              </Text>
            </View>
            <View>
              <Text style={style.innerTextBig}>
                {(allItems.filter(item => item.completed && item.success)
                  .length /
